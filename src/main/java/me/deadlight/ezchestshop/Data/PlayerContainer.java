...
public class PlayerContainer {
  ...
  public HashMap<String, CheckProfitEntry> getProfits() {
    if (checkProfits == null) {
      ...
      String checkProfitsList = db.getString(
        "uuid",
        suuid,
        "checkprofits",
        "playerdata"
      ...
      if (
        checkProfitsList == null ||
        checkProfitsList.equalsIgnoreCase("") ||
        checkProfitsList.equalsIgnoreCase("NULL")
      ) {
        checkProfits = new HashMap<>();
        return checkProfits;
      }
  ...
  public void updateProfits(
    ...
    Database db = EzChestShop.getPlugin().getDatabase();
    String profit_string = checkProfits
      .entrySet()
      .stream()
    ...
    if (profit_string == null) db.setString(
      "uuid",
      suuid,
      "checkprofits",
      "playerdata",
