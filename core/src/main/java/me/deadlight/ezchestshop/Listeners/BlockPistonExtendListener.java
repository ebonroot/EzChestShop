          ...
          if (ShopContainer.isShop(shulkerLoc)) {
            ...
            Bukkit
              ...
              .scheduleSyncDelayedTask(
                ...
                () -> {
                  Collection<Entity> entitiyList = block
                    .getWorld()
                    .getNearbyEntities(shulkerLoc, 2, 2, 2);
                    ...
                    if (entity instanceof Item) {
                      ...
                      if (Utils.isShulkerBox(itemStack.getType())) {
                        ...
                        if (lock != null && lockList.contains(lock)) {
                          ...
                          metaContainer =
                            ShopContainer.copyContainerData(
                              container,
                              metaContainer
                            );
                          ...
                          ShulkerShopDropEvent shopDropEvent = new ShulkerShopDropEvent(
                            item,
                            shulkerLoc
                          );
  ...
  public void InventoryItemPickup(InventoryPickupItemEvent event) {
    ...
    if (Utils.isShulkerBox(itemStack.getType())) {
      ...
      if (lock != null && lockList.contains(lock)) {
        ...
        PersistentDataContainer metaContainer = meta.getPersistentDataContainer();
        metaContainer =
          ShopContainer.copyContainerData(container, metaContainer);
        meta = addLore(meta, metaContainer);
        itemStack.setItemMeta(meta);
