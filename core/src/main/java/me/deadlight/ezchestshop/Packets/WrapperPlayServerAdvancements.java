...
public class WrapperPlayServerAdvancements extends AbstractPacket {
  ...
  private static final AutoWrapper<AdvancementDisplay> DISPLAY = AutoWrapper
    ...
    .field(
      ...
      EnumWrappers.getGenericConverter(
        getMinecraftClass("AdvancementFrameType"),
        FrameType.class
      )
    );
  ...
  private static final AutoWrapper<CriterionProgress> CRITERION = AutoWrapper.wrap(
    CriterionProgress.class,
    "CriterionProgress"
  );
  ...
  private static final AutoWrapper<AdvancementProgress> PROGRESS = AutoWrapper
    ...
    .field(
      0,
      BukkitConverters.getMapConverter(
