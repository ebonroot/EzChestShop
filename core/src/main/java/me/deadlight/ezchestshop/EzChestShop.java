...
public final class EzChestShop extends JavaPlugin {
  ...
  public void onEnable() {
    plugin = this;
    logConsole(
      "&c[&eEzChestShop&c] &aEnabling EzChestShop - version " +
    ...
    if (
      !(
        getServer().getVersion().contains("1.18") ||
        getServer().getVersion().contains("1.17") ||
        getServer().getVersion().contains("1.16")
      )
    ) {
      logConsole(
        "&c[&eEzChestShop&c] &4This is an 1.18/1.17 only version, your build is outdated! Self disabling..."
      );
    ...
    if (getServer().getPluginManager().getPlugin("ProtocolLib") != null) {
      ...
      logConsole(
        "&c[&eEzChestShop&c] &4ProtocolLib is not installed. Disabling the plugin..."
      );
      Bukkit.getPluginManager().disablePlugin(this);
      return;
    }
  ...
  private void registerListeners() {
    getServer()
      .getPluginManager()
      .registerEvents(new ChestOpeningListener(), this);
    getServer()
      .getPluginManager()
    ...
    getServer()
      .getPluginManager()
      .registerEvents(new PlayerTransactionListener(), this);
    getServer().getPluginManager().registerEvents(new ChatListener(), this);
    getServer()
      .getPluginManager()
      .registerEvents(new BlockPistonExtendListener(), this);
    getServer().getPluginManager().registerEvents(new SQLite(this), this);
    getServer()
      .getPluginManager()
      .registerEvents(new CommandCheckProfits(), this);
    ...
    if (Config.holodistancing) {
      getServer()
        .getPluginManager()
        .registerEvents(new PlayerCloseToChestListener(), this);
    } else {
      getServer()
        .getPluginManager()
        .registerEvents(new PlayerLookingAtChestShop(), this);
      getServer()
        .getPluginManager()
        .registerEvents(new PlayerLeavingListener(), this);
    }
  }
  ...
  public static void logConsole(String str) {
    EzChestShop
      ...
      .getServer()
      .getConsoleSender()
      .sendMessage(Utils.colorify(str));
  }

  public static void logDebug(String str) {
    if (Config.debug_logging) EzChestShop
      .getPlugin()
      .getServer()
      .getConsoleSender()
      .sendMessage("[Ecs-Debug] " + Utils.colorify(str));
  }
